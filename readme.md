...
| **MPU**                  |Microprocesor(Microprocessor Unit)| Samostatný procesor vyžadující externí RAM a úložiště, zpravidla běží plnohodnotný OS (Linux)        |                                             |Chytré telefony, osobní počítače, Wi-Fi router, multimediální systémy v automobilech nebo pokročilé síťové prvky|
| **Embedded**             |Embedded PLC (Embedded Programmable Logic Controller)|**klasický PLC automat integrovaný přímo na desku plošných spojů| Embedded PLC, Embedded PC                   | Bílá technika, bankomaty, regulace kotlů |
